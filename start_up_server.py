...
publique_ssh_key = 'ssh-rsa  aurelienjacquesjeanpetit@Aureliens-MacBook-Pro.local'
...
class basic_server_settings():
	...
	def __set_deploy_user(self, deploy_user):
		...
		if deploy_user is None or deploy_user == '':
